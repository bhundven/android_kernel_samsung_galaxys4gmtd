...
CROSS_COMPILE=${CROSS_COMPILE:-"ccache /opt/arm-2009q3/bin/arm-none-linux-gnueabi-"}
DEF_INITRAMFS_PATH=${DEF_INITRAMFS_PATH:-"/build/galaxys4gmtd/android_initramfs_samsung_galaxys4g"}
